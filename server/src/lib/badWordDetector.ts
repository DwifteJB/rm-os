...
const acceptableBadWords = [
    "fuck",
    "shit",
    "bitch"
]

const removeAcceptableBadWords = (message: string, badWords: string[]): string => {
...
export const checkForBadWords = async (message: string): Promise<BadWordResponse> => {
