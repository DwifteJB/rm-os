...
app.use('/epoxy/', createProxyMiddleware({
...
app.use('/baremux/', createProxyMiddleware({
...
app.use('/baremod/', createProxyMiddleware({
...
const port = 3000;
server.listen(port, () => {
    console.log(`Vite development proxy server running at http://localhost:${port}`);
});
